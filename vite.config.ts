        ...
        return {
            ...
            resolve: {
                ...
                alias: [
                    ...
                    { find: "aljabr/ui/prose/jsx-dev-runtime",  replacement: resolve(__dirname, "src/ui/prose/jsx-dev-runtime.ts") },
                    { find: "aljabr/ui/prose/jsx-runtime",      replacement: resolve(__dirname, "src/ui/prose/jsx-runtime.ts") },
                    { find: "aljabr/ui/prose",                  replacement: resolve(__dirname, "src/ui/prose/index.ts") },
        ...
        build: {
            ...
            lib: {
                entry: {
                    ...
                    "ui-prose": resolve(__dirname, "src/ui/prose/index.ts"),
                    "ui-prose-jsx-runtime": resolve(__dirname, "src/ui/prose/jsx-runtime.ts"),
                    "ui-prose-jsx-dev-runtime": resolve(__dirname, "src/ui/prose/jsx-dev-runtime.ts"),
                },
                formats: ["es", "cjs"],
            },
        },
