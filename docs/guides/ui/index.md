...
The reactive primitives (`Signal`, `Derived`, `Store`, `List`, `Scope`) are renderer-agnostic — pick them up from the [prelude guides](../) and they compose with either renderer unchanged.
